  ...
  return (
    <section id="subsidy" className="bg-gray-100 py-16 px-6">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        {/* Document List */}
        <article
          className="mt-6 bg-white shadow-lg rounded-lg p-6 text-left"
        ...
        <article
          className="mt-10 bg-white shadow-lg rounded-lg p-6 text-left"
          aria-labelledby="solar-benefits"
        >
          <h3
            id="solar-benefits"
            className="text-xl font-semibold text-green-700 mb-4"
          ...
          <ul className="space-y-3 text-gray-700 text-lg list-none">
            {t("benefits_list", { returnObjects: true }).map(
              (benefit, index) => (
                <li key={index} className="flex items-center space-x-2">
                  <span className="text-yellow-500 text-xl" aria-hidden="true">
                    🔹
                  </span>
                  <span>{benefit}</span>
                </li>
